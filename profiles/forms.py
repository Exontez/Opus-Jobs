...
class JobListingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['job_title', 'pay_rate', 'employment_type', 'job_description', 'business_address_region',
            'business_address_suburb', 'business_industry', 'telephone', 'email', 'area_code']
        widgets = {
            ...
            'business_address_suburb': forms.Select(attrs={'class': 'form-input'}),
            'business_industry': forms.Select(attrs={'class': 'form-input'}),
            'email': forms.EmailInput(attrs={'class': 'form-input', 'placeholder': 'Email'}),
            'telephone': forms.TextInput(attrs={'class': 'form-input', 'placeholder': 'Contact Number'}),
            'area_code': forms.Select(attrs={'class': 'form-input'}),
        }
